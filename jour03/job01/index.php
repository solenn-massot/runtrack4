    ...
    <main class="mx-0 px-0">
        ...
        <section class="row d-flex justify-content-around align-items-start">
            ...
            <div class="jumbotron col-8 mx-0">
                ...
                <p class="lead">Il existe plusieur visions du terme: </br>
        ...
        <div class="row mx-auto">
                ...
                <svg class="bi bi-arrow-bar-left col-auto row" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="progress col-10">
                    <div class="progress-bar progress-bar-striped progress-bar-animated bg-warning row" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: 75%"></div>

                </div>

                <svg class="bi bi-arrow-bar-right col-auto row" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
